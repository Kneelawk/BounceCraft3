...
public abstract class BounciumFluid extends FlowableFluid {
    public static class Flowing extends BounciumFluid {
        @Override
    ...
    public static class Still extends BounciumFluid {
        @Override
        public int getLevel(FluidState state) {
            return 8;
        }
    ...
    public Fluid getFlowing() {
        return BCFluids.BOUNCIUM_FLOWING;
    }

    @Override
    public Fluid getStill() {
        return BCFluids.BOUNCIUM;
    }
